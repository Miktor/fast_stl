...
PyObject *fast_loess(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTuple(args, "OOO", &soretd_x, &soretd_y, &samples, &neighbours)) {
        return NULL;
	}
	...
	if(soretd_x_length != 1 || soretd_y_length != 1)
	{
...
static PyMethodDef fast_loess_functions[] = {
    { "example", (PyCFunction)fast_loess, METH_VARARGS | METH_KEYWORDS, fast_loess_doc },
